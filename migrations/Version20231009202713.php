 ...
 */
final class Version20231009202713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reviews (id INT NOT NULL, start_rating INT DEFAULT NULL, review_text VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    }
